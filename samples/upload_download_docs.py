...
from classes.liste import Documente_remorci
    ...
    def interfata(self):
        ...
        if len(lista_documente) > 0:
            for i, doc in enumerate(lista_documente):
                ...
                self.add_new_button.grid(row=i+2, column=b, sticky=W, padx=10, pady=10)
