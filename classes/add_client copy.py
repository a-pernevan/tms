...
class Adauga_client:
    ...
    def main_window(self, master):
        ...
        self.detail_frame = LabelFrame(master, text="Detalii firma", padx=10, pady=10)
        self.detail_frame.grid(row=0, column=0, padx=10, pady=10)

        self.nume_firma_label = Label(self.detail_frame, text="Nume:* ")
        self.nume_firma_label.grid(row=0, column=0, sticky="w")

        self.nume_firma_input = Entry(self.detail_frame, width=50)
        self.nume_firma_input.grid(row=0, column=1, columnspan=3, sticky="w")

        self.cui_firma_label = Label(self.detail_frame, text="CUI:* ", anchor="e", justify=LEFT)
        self.cui_firma_label.grid(row=1, column=0, sticky="w", pady=5)

        self.cui_label = Frame(slef.detail_frame)
        self.cui_label.grid(row=1, column=1, sticky="w", columnspan=3)

        self.cui_firma_tara = Entry(self.cui_label, width=5)
        self.cui_firma_tara.grid(row=0, column=0, sticky="w", pady=5)

        self.cui_firma_nr = Entry(self.cui_label, justify=LEFT)
        self.cui_firma_nr.grid(row=0, column=1, sticky="w", pady=5)

        self.get_mfinante = Button(self.cui_label, text="Preluare ANAF", command=check_anaf)
        self.get_mfinante.grid(row=0, column=2, pady=5, sticky="w", padx=5)
# TO DO !!
